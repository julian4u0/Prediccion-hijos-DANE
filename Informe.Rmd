---
title: "Informe"
author: "Nombre de los integrantes: <br>Julian Alejandro Usuga Ortiz<br> Juan Jose Hurtado Alvarez<br> Diego de Oliveira Hitzges<br>"
date: "4/4/2021"
...
Para evaluar un nuevo hogar, su vector de atributos es estandardizado y despues pasa toda la red neuronal (usando los parametros que se obtuvieron durante el entrenamiento) para obtener una estimación "y_hat" y este "y_hat" se desestandariza y finalmente se redondeado para obtener la predicción.
